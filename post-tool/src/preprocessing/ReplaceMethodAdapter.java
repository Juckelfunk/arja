...
public class ReplaceMethodAdapter extends MethodVisitor implements Opcodes {
	final String newOwner = Type.getInternalName(AssertHelper.class);
	final String assertJ4Class = "org/junit/Assert";
	final String assertJ3Class = "junit/framework/Assert";
	final Set<String> assertJ3Methods = new LinkedHashSet<>(
			Arrays.asList( 
	...
	final Set<String> assertJ4Methods = new LinkedHashSet<>(Arrays.asList(
			"assertTrue(Z)V",
			"assertTrue(Ljava/lang/String;Z)V",
			"fail(Ljava/lang/String;)V",
			"fail()V",
