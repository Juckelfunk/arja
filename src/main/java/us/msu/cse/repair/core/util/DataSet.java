...
public class DataSet {
	public static LinkedHashMap<String, Object> getDefects4JProgram(String defects4jRoot, String proj, int id)
			throws IOException {
	...
	public static LinkedHashMap<String, Object> getSeedMath85Program(String seedMath85Root, int id) throws IOException {
		LinkedHashMap<String, Object> info = new LinkedHashMap<String, Object>();
	...
	public static LinkedHashMap<String, Object> getSeedMath85TMProgram(String seedMath85TMRoot, int id) throws IOException {
		LinkedHashMap<String, Object> info = new LinkedHashMap<String, Object>();
