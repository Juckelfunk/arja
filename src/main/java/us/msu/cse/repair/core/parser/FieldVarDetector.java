...
public class FieldVarDetector {
	...
	public FieldVarDetector(List<ModificationPoint> modificationPoints, Map<String, ITypeBinding> declaredClasses,
		...
		declaredFieldMap = new LinkedHashMap<String, Map<String, VarInfo>>();
		inheritedFieldMap = new LinkedHashMap<String, Map<String, VarInfo>>();
		outerFieldMap = new LinkedHashMap<String, Map<String, VarInfo>>();
	...
	void detectVisibleFields(String className) throws ClassNotFoundException {
		...
		Map<String, VarInfo> inheritedFields = new LinkedHashMap<String, VarInfo>();
		...
		LinkedHashMap<String, VarInfo> outerFields = new LinkedHashMap<String, VarInfo>();
	...
	Map<String, VarInfo> getStaticFields(Map<String, VarInfo> fields) {
		Map<String, VarInfo> staticFields = new LinkedHashMap<String, VarInfo>();
