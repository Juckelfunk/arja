...
public class MethodDetector {
	...
	public MethodDetector(List<ModificationPoint> modificationPoints, Map<String, ITypeBinding> declaredClasses,
		...
		declaredMethodMap = new LinkedHashMap<String, Map<String, MethodInfo>>();
		inheritedMethodMap = new LinkedHashMap<String, Map<String, MethodInfo>>();
		outerMethodMap = new LinkedHashMap<String, Map<String, MethodInfo>>();
	...
	void detectVisibleMethods(String className) throws ClassNotFoundException {
		...
		Map<String, MethodInfo> inheritedMethods = new LinkedHashMap<String, MethodInfo>();
		...
		LinkedHashMap<String, MethodInfo> outerMethods = new LinkedHashMap<String, MethodInfo>();
	...
	Map<String, MethodInfo> getStaticMethods(Map<String, MethodInfo> methods) {
		Map<String, MethodInfo> staticMethods = new LinkedHashMap<String, MethodInfo>();
