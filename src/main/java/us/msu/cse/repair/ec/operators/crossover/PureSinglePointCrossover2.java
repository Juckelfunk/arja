...
public class PureSinglePointCrossover2 extends Crossover {
	...
	public PureSinglePointCrossover2(LinkedHashMap<String, Object> parameters) {
		super(parameters);
	...
	public Solution[] doCrossover(double probability, Solution parent1, Solution parent2) throws JMException {
		...
		//	crossoverPoint = size + k;
			...
			crossoverPoint = 2 * size + PseudoRandom.randInt(0, size - 1);
