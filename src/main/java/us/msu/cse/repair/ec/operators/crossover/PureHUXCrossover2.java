...
public class PureHUXCrossover2 extends Crossover {
	/**
	 * 
	 */
	...
	public PureHUXCrossover2(LinkedHashMap<String, Object> parameters) {
		super(parameters);
	...
	public Object execute(Object object) throws JMException {
		...
		if (!(VALID_TYPES.contains(parents[0].getType().getClass())
			...
			Configuration.logger_.severe("PureHUXCrossover2.execute: the solutions "
		...
		if (parents.length < 2) {
			Configuration.logger_.severe("PureHUXCrossover2.execute: operator " + "needs two parents");
			Class<?> cls = java.lang.String.class;
			String name = cls.getName();
			throw new JMException("Exception in " + name + ".execute()");
		}
